...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Para APK: usar formato sento://invite/...
    // El esquema "sento://" está configurado en app.json
    const deepLink = `sento://invite/${group_id}?t=${inviteToken}`;
    
    // Este link tipo sento:// abrirá la app directamente si está instalada
    // Android/iOS capturarán el intent y abrirán la pantalla join
